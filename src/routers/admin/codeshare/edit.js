...
console.log("[Delicacy]: Admin/CodeShare/Edit router loaded.");
...
app.post("/admin/editcode/:code", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(global.config.server.channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://monitoring.delicacysound.repl.co/user/${req.user.id})** edited the code named **${rBody['codename']}**.`)
