...
console.log("[Delicacy]: Botlist/Add Bot router loaded.");
    ...
    app.post("/addbot", global.checkAuth, async (req,res) => {
      ...
      client.channels.cache.get(channels.botlog).send(`<@${req.user.id}> has been added by **${a.tag}** \n **https://monitoring.delicacysound.repl.co/bot/${a.id}/**`)
      })
    })
