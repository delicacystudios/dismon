...
console.log("[Delicacy/servers]: Add Server router loaded.");
...
app.post("/add", global.checkAuth, async (req,res) => {
    ...
    client.channels.cache.get(global.config.server.channels.botlog).send(`<@${checkGuilds.ownerID}> has approved **${guild.name}** \n https://monitoring.delicacysound.repl.co/server/${checkGuilds.id}/`)
