...
exports.run = async (client, message, args) => {
	...
	if(!findServer) return message.channel.send(
		"This server was not found in our list.\nAdd your server: https://monitoring.delicacysound.repl.co/server/add"
	);
  	if (findUser) {
    ...
    .setStyle("url")
    .setURL("https://monitoring.delicacysound.repl.co/server/"+message.guild.id)
